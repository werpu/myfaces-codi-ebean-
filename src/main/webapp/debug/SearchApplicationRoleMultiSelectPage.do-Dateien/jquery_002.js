...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnDraw( oSettings )
		{
            ...
            //fixup ei loses the checked functionality
            var elChecked = {};
            $("input:checked", oSettings.nTBody).each(function(index, element){
                elChecked[element.id] = true;
            });
            ...
            //now we reassign the checked as well to fix an ie6 issue here
